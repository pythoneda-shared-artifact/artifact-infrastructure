"""
pythoneda/shared/artifact/infrastructure/artifact/cli/artifact_commit_tagged_cli_handler.py
...
from pythoneda.shared.artifact.events.artifact import ArtifactCommitTagged
