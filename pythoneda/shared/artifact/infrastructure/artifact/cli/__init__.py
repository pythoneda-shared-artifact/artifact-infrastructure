"""
pythoneda/shared/artifact/infrastructure/artifact/cli/__init__.py

This file ensures pythoneda.shared.artifact.infrastructure.artifact.cli is a namespace.
